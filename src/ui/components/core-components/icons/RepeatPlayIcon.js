...
const RepeatPlayIcon = () => {
    return (
        <span className={style.icon}>
            <svg viewBox="0 0 32 32">
                <path
                    d="M24.6,11.5c-0.3-0.5-0.9-0.6-1.4-0.3c-0.5,0.3-0.6,0.9-0.3,1.4c0.7,1,1,2.2,1,3.4c0,3.3-2.7,6-6,6h-4c-3.3,0-6-2.7-6-6
